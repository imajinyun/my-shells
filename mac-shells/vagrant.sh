...
if [[ $# -eq 0 ]]; then
    ...
    groups=(
        ...
        [phpunit-install]="wget https://phar.phpunit.de/phpunit.phar && chmod +x phpunit.phar && mv phpunit.phar /usr/local/bin/phpunit"
        ...
        [util]="$brew install unrar archey wget bash curl sl htop tree"
    )
